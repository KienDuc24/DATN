...
// SỬA 1: Dùng 'require' để import JSON.
// Node.js sẽ tự động đọc và phân tích file này thành một đối tượng JavaScript.
...
// 2. XÓA BỎ: Khối 'try...catch' dùng 'fs.readFileSync' đã bị xóa vì nó
// gây lỗi 500 trên server.
...
---
(SỬA 2: Dùng JSON.stringify() để biến đối tượng 'gameRules' thành một chuỗi JSON sạch cho AI đọc)
...
// 4. Hàm xử lý câu hỏi mới (Giữ nguyên, đã đúng)
